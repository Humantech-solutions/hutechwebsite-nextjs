                ...
                >
                  ...
                  <div className="p-10 flex flex-col flex-grow space-y-6">
                    ...
                    <div className="mt-auto pt-8 border-t border-gray-50">
                      <Link href={`/blogs/${blog.id}`} className="inline-flex items-center gap-3 text-[#001A3D] font-black text-xs uppercase tracking-[0.2em] group/link hover:text-[#FFAF2B] transition-all">
