...
import { NewsItem } from "@/lib/wordpress";
...
export default function NewsClient({
  heroTagline = "Corporate Insights",
  heroTitle = "In The |News.",
  heroDescription = "Keeping you updated with our latest milestones, global expansions, and industry-defining engineering breakthroughs.",
  heroBgImage = "https://images.unsplash.com/photo-1583737177755-74c167f871eb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920",
  ctaTitle = "Media Inquiries",
  ctaDescription = "For press kits, high-resolution imagery, or executive interview requests, please contact our global communications office.",
  ctaBtnText = "Contact Press Team",
  ctaBtnUrl = "/contact",
  newsItems = DEFAULT_NEWS_ITEMS,
}: NewsClientProps) {
  
  const displayItems = newsItems.length > 0 ? newsItems : DEFAULT_NEWS_ITEMS;
