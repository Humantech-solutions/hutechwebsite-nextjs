...
const EVENTS_DATA = {
  ...
  "sustainability-in-tech-symposium": {
    ...
    description:
      "Join international experts and engineers as we explore how architectural decisions and software efficiency can significantly reduce the carbon footprint of global digital infrastructure.",
    agenda: [
    ...
    speakers: [
      {
        name: "Anna Schmidt",
        role: "Sustainability Lead, Hutech",
        image:
      ...
      },
      {
        ...
        role: "Founder, GreenCloud Labs",
        image:
          "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
      },
    ],
    highlights: [
