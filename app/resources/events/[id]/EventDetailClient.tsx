          ...
          <div className="grid grid-cols-1 items-center gap-24 lg:grid-cols-2">
            <div className="space-y-10">
              <h2 className="display-font text-5xl leading-tight font-bold tracking-tight text-[#001A3D] md:text-7xl">
                Missed this <br />
                <span className="text-[#0171c1]">Event?</span>
              </h2>
              <p className="max-w-lg text-xl leading-relaxed font-medium text-gray-500">
                Gain access to exclusive event transcripts, recording links, and early notification
                of upcoming engineering summits.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square rotate-3 overflow-hidden rounded-[4rem] shadow-[0_64px_128px_-32px_rgba(0,0,0,0.2)]">
                ...
                />
                <div className="group absolute inset-0 flex cursor-pointer items-center justify-center bg-[#001A3D]/30">
