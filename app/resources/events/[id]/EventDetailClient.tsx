  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <section className="relative overflow-hidden bg-[#001A3D] text-white">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1280px] px-6 pb-16 pt-[70px] lg:px-20">
          <Motion.div
          ...
          >
            <Link
              ...
              className="group inline-flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-[#0171c1] transition-all hover:text-white"
            >
            ...
            <div className="flex flex-wrap gap-3">
              <span className="rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[10px] font-bold uppercase tracking-wider text-[#FFAF2B]">
                {event.category?.toUpperCase()}
              </span>
              <span className="rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[10px] font-bold uppercase tracking-wider text-[#0171c1]">
                {event.type?.toUpperCase()}
              </span>
            </div>

            <div className="space-y-4 pt-2">
              <h1 className="max-w-5xl text-4xl font-semibold leading-tight tracking-tight text-white md:text-6xl lg:text-[64px]">
      ...
      {/* Newsletter CTA Section - Inline Video */}
          ...
          <div className="flex flex-col items-center gap-[48px] lg:flex-row">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <form
                ...
                className="flex w-full flex-col gap-[12px] md:flex-row md:gap-[16px]"
              >
                <input
                  required
                  type="email"
                ...
                <button
                  ...
                  className="h-[56px] w-full rounded-[8px] bg-[#0171c1] text-[14px] font-bold uppercase tracking-[2px] text-white transition-colors duration-300 hover:bg-blue-600 disabled:cursor-not-allowed disabled:opacity-50 md:w-[180px]"
                >
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative aspect-video w-full overflow-hidden rounded-[20px] bg-black shadow-xl md:rounded-[24px]">
                ...
                {/* Inline Video Player */}
                {showVideo && ctaVideoUrl && (
                  <>
                    <iframe
                      src={
                        ctaVideoUrl.includes("youtube.com/watch")
                          ? ctaVideoUrl.replace("watch?v=", "embed/") + "?autoplay=1&rel=0"
                          : ctaVideoUrl.includes("youtu.be/")
                            ? ctaVideoUrl.replace("youtu.be/", "youtube.com/embed/") +
                              "?autoplay=1&rel=0"
                            : ctaVideoUrl
                      }
