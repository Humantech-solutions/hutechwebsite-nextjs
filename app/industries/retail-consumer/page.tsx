            ...
            <div className="rounded-sm border border-gray-100 bg-white p-10 shadow-2xl md:p-14 lg:col-span-7">
              ...
              <form className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  <button
                    type="button"
                    className="w-full rounded-sm bg-[#FFAF2B] px-12 py-5 text-[11px] font-bold tracking-wider text-[#001A3D] uppercase shadow-xl transition-all duration-500 hover:bg-[#001A3D] hover:text-white md:w-auto"
                  >
