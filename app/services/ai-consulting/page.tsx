          ...
          <div className="grid grid-cols-1 gap-20 lg:grid-cols-12">
            <div className="rounded-sm border border-gray-100 bg-white p-10 shadow-2xl md:p-14 lg:col-span-7">
              ...
              <InlineContactForm
                ...
                textareaPlaceholder="Tell us about your prompt engineering and AI needs"
              />
            </div>
        ...
        <div className="mx-auto max-w-[1280px] px-6 lg:px-20">
          <div className="mb-16 flex items-end justify-between gap-8">
            <div className="max-w-2xl space-y-6">
              <h2 className="display-font text-3xl font-semibold text-[#001A3D] md:text-5xl">
                AI Consulting Insights & Articles
              </h2>
              <p className="text-lg font-medium text-gray-500">
                Explore our latest thinking on AI strategy and advanced prompt design trends.
              </p>
            </div>
            <Link
              href="/resources"
