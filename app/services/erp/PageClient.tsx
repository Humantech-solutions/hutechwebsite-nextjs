          ...
          <div className="grid grid-cols-1 gap-20 lg:grid-cols-12">
            <div className="rounded-sm border border-gray-100 bg-white p-10 shadow-2xl md:p-14 lg:col-span-7">
              <h2 className="display-font mb-10 text-3xl font-bold text-[#001A3D]">
                Start Your Enterprise Digital Solutions Project
              </h2>
              <InlineContactForm
                category="Enterprise Digital Solutions"
                textareaPlaceholder="Tell us about your enterprise architecture and ERP needs"
              />
            </div>
            <div className="space-y-12 py-8 lg:col-span-5">
              ...
              <div className="space-y-10">
                {[
                  {
                    icon: MessageSquare,
                    text: "A senior enterprise architect reviews your platform goals and contacts you within 4 business hours.",
                  },
                  {
                    icon: FileText,
                    text: "We schedule an assessment to map your current business processes and software systems.",
                  },
                  {
                    icon: Sparkles,
                    text: "You receive a detailed implementation proposal including platform options and cost analysis.",
                  },
                ].map((step, i) => {
        ...
        <div className="mx-auto max-w-[1280px] px-6 lg:px-20">
          <div className="mb-16 flex items-end justify-between gap-8">
            <div className="max-w-2xl space-y-6">
              <h2 className="display-font text-3xl font-semibold text-[#001A3D] md:text-5xl">
                Enterprise Insights & Articles
              </h2>
              <p className="text-lg font-medium text-gray-500">
                Explore our latest thinking on enterprise technology and digital core trends.
              </p>
            </div>
            <Link
              href="/resources"
