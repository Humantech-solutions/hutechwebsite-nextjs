        ...
        <div className="relative z-10 mx-auto w-full max-w-[1280px] px-6 lg:px-20">
          ...
          >
            ...
            <p className="max-w-2xl text-lg leading-relaxed font-medium text-gray-300 md:text-xl">
              We craft intelligent data-driven dashboards and reporting experiences through cutting-edge
              visualization techniques and expert BI consulting for global enterprise leaders.
            </p>
          </Motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 items-center gap-20 lg:grid-cols-2">
            <div className="space-y-10">
              <div className="space-y-6">
                <h2 className="display-font text-3xl leading-tight font-semibold text-[#001A3D] md:text-5xl">
                  Empowering Organizations with Smart, Interactive Analytics Solutions
                </h2>
              ...
              <div className="space-y-6">
                <p className="text-lg leading-relaxed font-medium text-gray-500">
                  ...
                  managing integrated business intelligence platforms. Our end-to-end solutions include
                  dashboard implementation, custom report engineering, performance optimization, and
                  seamless data source integrations.
                </p>
                <p className="text-lg leading-relaxed font-medium text-gray-500">
                  We ensure our clients can operate with agility, clarity, and precision, enabling
                  them to expand operations and integrate fresh visual solutions to meet specific
                  reporting and market decision needs.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -left-10 hidden max-w-xs space-y-4 bg-[#0171c1] p-10 text-white shadow-2xl md:block">
                ...
                <h3 className="display-font text-xl font-bold">Metrics that Matter</h3>
                <p className="text-sm leading-relaxed font-medium opacity-80">
                  Integrating advanced AI diagnostics and interactive filters across BI platforms to
                  streamline reporting tasks and enhance digital agility.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-20 lg:grid-cols-12">
            <div className="rounded-sm border border-gray-100 bg-white p-10 shadow-2xl md:p-14 lg:col-span-7">
              ...
              <InlineContactForm
                ...
                textareaPlaceholder="Tell us about your business intelligence and dashboard reporting needs"
              />
            </div>
        ...
        <div className="mx-auto max-w-[1280px] px-6 lg:px-20">
          <div className="mb-16 flex items-end justify-between gap-8">
            <div className="max-w-2xl space-y-6">
              <h2 className="display-font text-3xl font-semibold text-[#001A3D] md:text-5xl">
                DataViz Insights & Articles
              </h2>
              <p className="text-lg font-medium text-gray-500">
                Explore our latest thinking on business intelligence technology and data trends.
              </p>
            </div>
            <Link
              href="/resources"
