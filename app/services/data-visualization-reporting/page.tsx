    ...
    <div className="flex flex-col overflow-hidden bg-white">
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div className="flex-1 relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-[#0171c1] p-8 text-white max-w-xs shadow-2xl hidden md:block">
                ...
                <h3 className="text-xl font-bold display-font mb-2 text-white">Metrics that Matter</h3>
                <p className="text-xs opacity-80 leading-relaxed font-medium text-white">
      ...
      <section className="py-24 bg-[#0171c1] text-white">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-20 text-center space-y-10">
          <h2 className="text-4xl md:text-6xl font-bold display-font text-white">See Your Data Differently</h2>
          <p className="text-xl opacity-90 max-w-3xl mx-auto font-medium text-white">From executive dashboards to customer-facing analytics, we build the visual interfaces that power data-driven companies.</p>
